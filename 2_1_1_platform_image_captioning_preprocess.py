...
from 2_1_2_platform_image_captioning_preprocess_sub import exec_process
...
def init_svc(im, rule):
    ...
    data = "메모리에 로드된 tracking 결과값: 객체 id, 좌표값 등등"
    ...
    return {'model_blip': model_blip, 'processor_blip': processor_blip, 'model_sr': model_sr, 'processor_sr': pro_sr, 'cropped_images':images}
